...
class labelme2coco(object):
    def __init__(self, labelme_json=[], save_json_path="./annotations.json"): # 输出路径
        """
...
# file usage : python labelme2coco.py  ./pytorch_maskrcnn/JSON
# ./pytorch_maskrcnn/JSON : where json files are.